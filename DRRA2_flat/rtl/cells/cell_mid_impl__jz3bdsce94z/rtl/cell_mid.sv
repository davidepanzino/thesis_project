...
(
  ...
  assign ret_out = controller_ret_remember & ret_in_remember;
    ...
    (
        ...
        .bulk_data_out_0(bulk_data_out[1])    );

    `rf_impl resource_2_inst
    (
        .clk_0(resource_clk[2]),
        .rst_n_0(resource_rst_n[2]),
        .instr_en_0(instr_valid[2]),
        .instr_0(instr[2]),
        .activate_0(activate[2]),
        .word_data_in_0(word_data_in[2]),
        .word_data_out_0(word_data_out[2]),
        .bulk_data_in_0(bulk_data_in[2]),
        .bulk_data_out_0(bulk_data_out[2])    );

    `rf_impl resource_3_inst
    (
        ...
        .bulk_data_out_0(bulk_data_out[3])    );

    `dpu_impl resource_4_inst
    (
        .clk_0(resource_clk[4]),
        .rst_n_0(resource_rst_n[4]),
        .instr_en_0(instr_valid[4]),
        .instr_0(instr[4]),
        .activate_0(activate[4]),
        .word_data_in_0(word_data_in[4]),
        .word_data_out_0(word_data_out[4]),
        .bulk_data_in_0(bulk_data_in[4]),
        .bulk_data_out_0(bulk_data_out[4]),        .clk_1(resource_clk[5]),
        .rst_n_1(resource_rst_n[5]),
        .instr_en_1(instr_valid[5]),
        .instr_1(instr[5]),
        .activate_1(activate[5]),
        .word_data_in_1(word_data_in[5]),
        .word_data_out_1(word_data_out[5]),
        .bulk_data_in_1(bulk_data_in[5]),
        .bulk_data_out_1(bulk_data_out[5])    );
